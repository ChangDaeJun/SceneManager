...
public class DependencyResolverTests
{
    ...
    {
        var result = _resolver.Resolve([Program("A")]);
    ...
    public void Resolve_IndependentPrograms_AllInFirstGroup_OrderedByOrder()
    {
        ...
        var result = _resolver.Resolve([Program("A", order: 2), Program("B", order: 1)]);
    ...
    public void Resolve_CircularDependency_Throws()
    {
        ...
        Assert.Throws<CircularDependencyException>(() =>
            _resolver.Resolve([Program("A", dependsOn: "B"), Program("B", dependsOn: "A")]));
    }
    ...
    public void Resolve_MissingDependencyTarget_TreatedAsIndependent()
    {
        ...
        var result = _resolver.Resolve([Program("A", dependsOn: "GHOST")]);
